...
import {
  View, Text, Image, Dimensions, TextInput, ScrollView, Modal, TouchableOpacity, StyleSheet,
} from 'react-native'
import {
...
export default class CalculatorBMI extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      heightValue: '170',
  ...
  handleHeightValue = (text) => {
    this.setState({
      heightValue: text,
    })
  }

  handleWeightValue = (text) => {
    this.setState({
      weightValue: text,
    })
  }
  ...
  render() {
    const {
      heightValue, weightValue, resultBMI, isShowModal,
    } = this.state
    return (
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.bmi}>
            ...
            <View style={styles.result}>
              <TextInput
                ...
                value={heightValue}
                style={styles.input}
                onChangeText={this.handleHeightValue}
          ...
          <View style={styles.bmi}>
            ...
            <View style={styles.result}>
              <TextInput
                ...
                style={styles.input}
                value={weightValue}
                onChangeText={this.handleWeightValue}
                keyboardType="numeric"
              />
            </View>
          </View>
          ...
          <TouchableOpacity onPress={this.handleSubmitBMI}>
        ...
        >
          ...
          >
            <View>
              <TouchableOpacity onPress={this.handleExitModel}>
              ...
              >
                <View style={styles.resultBMI}>
                  ...
                  <Text style={{ ...Fonts.sfProTextBold, fontSize: 72 * calWidth, color: '#fff' }}>{resultBMI}</Text>
                </View>
              </View>
            </View>
          </View>
